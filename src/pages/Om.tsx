      ...
      <div className="grid-2">
        <div className="card card-pad">
          ...
          <ol style={{ paddingLeft: 18, lineHeight: 1.7 }}>
            ...
            <li>Som <strong>søker</strong> (Fiberlink Norge AS): se søknad <strong>KO-2026-0001</strong> — der er stolpe 3 avslått og strekkene rundt merket «krever ny trasévurdering».</li>
        ...
        <div className="card card-pad">
          ...
          <ul style={{ paddingLeft: 18, lineHeight: 1.8 }}>
            ...
            <li><strong>3 søkervirksomheter</strong>: Fiberlink Norge AS, Kystfiber AS, Bredbåndspartner AS.</li>
